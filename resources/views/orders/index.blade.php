<x-app-layout>
    {{-- Estados de los pedidos para el cliente --}}
    <div class="container py-12">

        <section class="grid grid-cols-5 gap-6 text-white">
            <a href="{{route('orders.index')."?status=1"}}" class="bg-pink-500 bg-opacity-80 rounded-lg px-12 pt-8 pb-4">
            ...
            <a href="{{route('orders.index')."?status=4"}}" class="bg-green-500 bg-opacity-80 rounded-lg px-12 pt-8 pb-4">
            ...
            <a href="{{route('orders.index')."?status=5"}}" class="bg-red-500 bg-opacity-80 rounded-lg px-12 pt-8 pb-4">
                    ...
                    <li>
                        <a href="{{route('orders.show', $order)}}" class="flex items-center py-2 px-4 hover:bg-gray-100">
                            <span class="w-12 text-center">
                                @switch($order->status)
                                    @case(1)
                                        <i class="fas fa-business-time text-pink-500 bg-opacity-80"></i>
                                    @break
                                    @case(2)
                                        <i class="fas fa-credit-card text-gray-500 bg-opacity-80"></i>
                                    @break
                                    @case(3)
                                        <i class="fas fa-truck text-yellow-500 bg-opacity-80"></i>
                                    @break
                                    @case(4)
                                        <i class="fas fa-check-circle text-green-500 bg-opacity-80"></i>
                                    @break
                                    @case(5)
                                        <i class="fas fa-times-circle text-red-500 bg-opacity-80"></i>
                                    @break
                                    @default
